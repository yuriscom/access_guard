...
def get_permissions_enforcer(settings=None, engine=None,
                             ...
                             query_provider: PolicyQueryProvider = None) -> PermissionsEnforcer:
    params = _build_params(settings)

    if new_instance:
        return PermissionsEnforcer(params, engine, query_provider=query_provider)

    return PermissionsEnforcer.get_instance(params, engine, query_provider=query_provider)